...
AppGenerator.prototype.ngFiles = function () {
  this.copy('app.js', 'app/app.js');
  this.copy('common/mainCtrl.js', 'app/common/mainCtrl.js');
  this.copy('common/views/main.html', 'app/common/views/main.html');
  this.copy('common/views/not-found.html', 'app/common/views/not-found.html');
}
...
AppGenerator.prototype.writeIndex = function () {
  ...
  this.indexFile = this.appendFiles({
    ...
    sourceFileList: ['app.js', 'common/mainCtrl.js']
  });
};
